...
public class SliderSide {
    ...
    public SliderSide(String video_slide, String video_type, String video_thumb, String video_url, String video_name, String video_description, String video_category) {
